...
while (playerHealth > 0 && enemyHealth > 0) {
    ...
    var promptFight = window.prompt("Would you like to FIGHT or SKIP this battle? Enter 'F' or 'S' to choose.");
        ...
        console.log(
        playerName + ' attacked ' + enemyName + '. Damage: ' + damage + '. ' + enemyName + ' now has ' + enemyHealth + ' health remaining.'
        );
        ...
        console.log(
        enemyName + ' attacked ' + playerName + '. Damage: ' + damage + '. ' + playerName + ' now has ' + playerHealth + ' health remaining.'
        );
...
var endGame = function() {
    ...
    if (playerHealth > 0) {
        window.alert("Great job, you've survived the game! You now have a score of " + playerMoney + " credits.");
    }
    else {
...
var shop = function() {
    ...
    switch (shopOptionPrompt) {
        ...
        case "r":
            if (playerMoney >= 7) {
            window.alert("Refilling " + playerName + "'s health by 20 for 7 credits.");
        ...
        case "u":
            if (playerMoney >= 7) {
            window.alert("Upgrading " + playerName + "'s attack by 6 for 7 credits.");
        ...
        case "leave": // new case
        case "l":
            window.alert(playerName + " left the shop.");
